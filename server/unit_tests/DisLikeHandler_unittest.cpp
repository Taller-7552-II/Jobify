...
TEST(DisLikeHandlerTests, DislikeOK){
	...
	struct http_message* hmsg = new_http_message("DELETE", "/like/juampa/matias", "", &header_names, &header_values);
