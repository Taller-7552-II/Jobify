...
TEST(UserGetProfileHandlerTests, UserGetProfileOK){
	...
	struct http_message* hmsg = new_http_message("GET", "/users/gonzalo/profile", "", &header_names, &header_values);
