...
HttpRequestConcrete::UriField HttpRequestConcrete::getUriParsedByIndex(int index){
    ...
    if(field.compare("users") == 0){
        ...
        return METADATA;
    } else if (field.compare("addFriend") == 0){
        return ADD_FRIEND;
    } else if (field.compare("deleteFriend") == 0){
        return DELETE_FRIEND;
    } else if (field.compare("like") == 0){
        return LIKE;
    } else if (field.compare("acceptFriend") == 0){
        return ACCEPT_FRIEND;
    } else if (field.compare("job") == 0){
        return JOB;
    } else if (field.compare("skill") == 0){
        return SKILL;
    } else if (field.compare("top") == 0){
        return TOP;
   } else if (field.compare("top_skill") == 0){
        return TOP_SKILL;
