#ifndef DATABASELEVELDB_H
#define DATABASELEVELDB_H

#include "leveldb/db.h"
#include "leveldb/status.h"
#include "Database.h"

//!Clase que maneja la base de datos con leveldb.
/*!Esta clase emplea como interface Database y utiliza leveldb para cumplir sus funciones.
*/
class DBElement;
